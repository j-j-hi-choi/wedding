...
function Account() {
  ...
  const groom1: AccountType = { bank: "농협", number: "352-2257-3234-63" };
  const groom2: AccountType = { bank: "국민", number: "904701-00-037167" };
  const groom3: AccountType = { bank: "국민", number: "727202-00-253222" };
